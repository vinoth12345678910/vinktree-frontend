      ...
      <main className="flex flex-col items-center gap-10 w-full max-w-3xl pt-24 pb-10">
        <div className="flex flex-col items-center gap-4">
          ...
          <div className="flex flex-col sm:flex-row gap-4 w-full justify-center mt-4">
            <Link
              className="rounded-lg border border-blue-600 text-blue-600 font-semibold px-8 py-3 shadow-lg transition text-center text-lg w-full sm:w-auto focus:ring-4 focus:ring-blue-300 bg-transparent"
              href="/register"
            >
              Get Started Free
            </Link>
